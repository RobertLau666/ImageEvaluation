...
def saturation_norm(saturation_score):
    '''
    The saturation score of the image
...
def PSNR_norm(PSNR_score):
    '''
    The PSNR (Peak Signal-to-Noise Ratio) score of the image
...
def SSIM_norm(SSIM_score):
    '''
    The SSIM (Structural Similarity Index Measure) score of the image
    Range: -1 to 1, where:
...
def variance_norm(variance_score):
    '''
    reflects the dispersion of the image gray value, that is, the contrast of the image.
